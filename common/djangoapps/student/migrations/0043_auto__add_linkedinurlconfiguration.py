...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LinkedInUrlConfiguration'
        db.create_table('student_linkedinurlconfiguration', (
        ...
        db.send_create_signal('student', ['LinkedInUrlConfiguration'])


    def backwards(self, orm):
        # Deleting model 'LinkedInUrlConfiguration'
        db.delete_table('student_linkedinurlconfiguration')
    ...
    models = {
        ...
        'student.linkedinurlconfiguration': {
            'Meta': {'object_name': 'LinkedInUrlConfiguration'},
            'change_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'changed_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
